...
class YOLO:
    def __init__(self, obj_threshold, nms_threshold):
        ...
        self._yolo = load_model('evrisimsel_sinir_aglari_nesne_tespiti//yolo//data//yolo.h5')
    ...
    def _process_feats(self, out, anchors, mask):
        ...
        anchors_tensor = tf.reshape(tf.Variable(anchors), (1, 1, len(anchors), 2))
        out = out[0]
