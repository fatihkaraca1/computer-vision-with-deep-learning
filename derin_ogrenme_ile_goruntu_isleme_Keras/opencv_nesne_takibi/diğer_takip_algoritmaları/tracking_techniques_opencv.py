...
gt = pd.read_csv("opencv_nesne_takibi\\diğer_takip_algoritmaları\\gt_new.txt")

video_path = "opencv_nesne_takibi\\diğer_takip_algoritmaları\\MOT17-13-SDP.mp4"
