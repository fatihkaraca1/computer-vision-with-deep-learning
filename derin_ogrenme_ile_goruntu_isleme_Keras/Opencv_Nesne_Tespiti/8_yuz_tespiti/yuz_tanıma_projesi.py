...
# içe aktar 
einstein = cv2.imread("Opencv_Nesne_Tespiti\\8_yuz_tespiti\\einstein.jpg", 0)
plt.figure(), plt.imshow(einstein, cmap = "gray"), plt.axis("off")

# sınıflandırıcı
face_cascade = cv2.CascadeClassifier("Opencv_Nesne_Tespiti\\8_yuz_tespiti\\haarcascade_frontalface_default.xml")
...
# barce
# içe aktar 
barce = cv2.imread("Opencv_Nesne_Tespiti\\8_yuz_tespiti\\barcelona.jpg", 0)
